...
public class TestData {
     ...
     *
     * @param minDays минимальное дней от сегодня
     * 
     * @param maxDays максимальное дней от сегодня
     * 
     * @return строка со случайной датой в будущем
     */
    ...
    /*
     * Вложенный класс с альтернативными маршрутами
     * Для разнообразия тестовых сценариев
     */
    ...
    /*
     * Возвращает случайный маршрут из доступных
     * Используется для нагрузочнго тестирования и разнообразия
     * 
     * @return случайный город назначения
     */
